...
public class CompanyAdmin extends BasePage
{
	...
	void Draft() throws InterruptedException, IOException
	{
		...
		MethodsPOM.DraftCount( test, workbook);
	...
	void PendingReview() throws InterruptedException, IOException
	{
		...
		MethodsPOM.PendingReviewApprovalCount( test, workbook, "Pending Review");
	...
	void Reviewed() throws InterruptedException, IOException
	{
		...
		MethodsPOM.ReviewedApprovedCount( test, workbook, "Reviewed");
	...
	void PendingApproval() throws InterruptedException, IOException
	{
		...
		MethodsPOM.PendingReviewApprovalCount( test, workbook, "Pending Approval");
	...
	void Approved() throws InterruptedException, IOException
	{
		...
		MethodsPOM.ReviewedApprovedCount( test, workbook, "Approved");
	...
	void Expired() throws InterruptedException, IOException
	{
		...
		MethodsPOM.ExpiredCount( test, workbook);
	...
	void MyReports() throws InterruptedException, IOException
	{
		...
		MethodsPOM.MyReports( test, workbook);
	...
	void CriticalDocuments() throws InterruptedException, IOException
	{
		...
		MethodsPOM.CriticalDocuments( test, workbook);
