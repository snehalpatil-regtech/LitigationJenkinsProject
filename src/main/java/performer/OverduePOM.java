...
public class OverduePOM extends BasePage
{
	...
	{
		performer = getDriver().findElement(By.xpath("(//label[@class='checkbox'][normalize-space()='Approver User'])[2]"));
		return performer;
	}
	public static WebElement clickPeopleCheckBoxSubFolder()		//Clicking on Checkbox in front of name
	{
		performer = getDriver().findElement(By.xpath("(//label[@class='checkbox'][normalize-space()='Approver User'])"));
		return performer;
	}
	...
	public static void MyReminder( ExtentTest test, String compliance) throws InterruptedException
	{
		...
		//action.moveToElement(clickMyReminder()).click().perform();	//Clicking on 'My Reminder'
