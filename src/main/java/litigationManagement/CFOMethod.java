...
//			OverduePOM.clickDashboard().click();
	...
	public static void RiskSummaryGraph1(ExtentTest test, String type,int counttype) throws InterruptedException, IOException
		
		{
			...
			{
				Thread.sleep(2000);
		        performerPOM.RiskSummaryMedium1().click();						//Clicking on 'Open' notice
			}
			else if(type.equalsIgnoreCase("Low Risk"))
			{
				Thread.sleep(2000);
	   ...
	   public static void DepartmentSummaryGraph1(ExtentTest test, String type) throws InterruptedException, IOException
		
			{
				...
				JavascriptExecutor js = (JavascriptExecutor) getDriver();
		      	...
		      	int	open = Integer.parseInt(performerPOM.DepartmentSummaryGraph2().getText());	//Reading Notice Open count.
			    performerPOM.DepartmentSummaryGraph2().click();						//Clicking on 'Open' notice
...
//    			{
//    				Thread.sleep(5000);
//    				ele1 = wait1.until(ExpectedConditions.visibilityOf(performerPOM.clickLinkNotice()));
...
//			
//			Thread.sleep(3000);
//			performerPOM.clickcategory1().click();
//			
//			
			if(performerPOM.clearButton().isEnabled())
	  		{
...
//				Thread.sleep(1000);
//				performerPOM.selectInternalUser5().click();
...
//				}
				...
				JavascriptExecutor jse=(JavascriptExecutor)getDriver();
				 jse.executeScript("arguments[0].click();",  OverduePOM.clickSaveButton());
						...
						JavascriptExecutor jse=(JavascriptExecutor)getDriver();
						 jse.executeScript("arguments[0].click();",  performerPOM.clickSaveResponse());
						  //performerPOM.clickSaveResponse().click();
							...
							Thread.sleep(3000);
							performerPOM.Description().clear();
							Thread.sleep(3000);
...
//				PaymentType1.get(2).click();
    	 ...
    	 public static int CountExcel( ExtentTest test, String type) throws InterruptedException, IOException
    		{
    		 WebDriverWait wait = new WebDriverWait(getDriver(), 300);
    			progress();
...
//    				}
   ...
   /* 				File dir9 = new File("C:\\Users\\snehalp\\Downloads");
        			...
        			CFOcountPOM.clickNextPage1().sendKeys(Keys.PAGE_UP);
        			Thread.sleep(250);
        			performerPOM.clickExcelReport().click();		
		 ...
		 public static void TaskActivity1(ExtentTest test) throws InterruptedException, IOException
			{
		      ...
		      ////XSSFSheet sheet = ReadExcel();
		       ...
		       Thread.sleep(500);
			    ...
			    Thread.sleep(5000);
			    performerPOM.clickHearingDate().sendKeys("24-03-2025");
...
//				performerPOM.clickMinimize().click();	
				...
				Thread.sleep(1000);
				performerPOM.clickTaskDesc().clear();
				...
				Thread.sleep(8000);
				String TaskClosed =performerPOM.clickNoticeTaskclosed().getText();
...
//					performerPOM.clickCaseHearingDate().sendKeys(HearingDate+"");	//Writing 'HearingDate'
				    ...
				    Thread.sleep(3000);
				    performerPOM.clickCaseHearingDecsri().sendKeys("Case Hearing14 JULY 2023");		//Writing 'HearingDescription'
			...
			public static void CaseOrder(ExtentTest test) throws InterruptedException, IOException
			{
				...
				////XSSFSheet sheet = ReadExcel();
				 ...
				 Thread.sleep(6000);
				 performerPOM. clickCaseOrderDate().sendKeys("23-08-2024");
				 Thread.sleep(3000);
				 ...
				 Thread.sleep(3000);
				 performerPOM.clickCaseOrderTitle().sendKeys("Order no 907");
				 Thread.sleep(3000);
...
//					performerPOM.clickEditNotice().click();//click edit notice
				...
				//-------------------------------------------Notice--------------------------------------------------
					...
					Thread.sleep(4000);
					performerPOM.startDate().sendKeys("05/01/2024");
					
					Thread.sleep(4000);
					performerPOM.endDate().sendKeys("05/7/2025");
					...
					performerPOM.clickCaseNotice1().click();
					 ...
					 /* Thread.sleep(3000);
				       ...
				       performerPOM.selectDocTypeFilterCA().click();
						...
						//List<WebElement> entitycol=.findElements(By.xpath("//*[@id='grid']/div[2]/table/tbody/tr/td[2]"));
			...
			performerPOM.selectTypeTask().click();
			 ...
			 /* Thread.sleep(3000);
		       ...
		       // li.add(locationtext);
				...
				//List<WebElement> Type=.findElements(By.xpath("//*[@id='grid']/div[2]/table/tbody/tr/td[3]"));
				    ...
				    Thread.sleep(3000);
					 ...
					 /* Thread.sleep(3000);
				       ...
				       Thread.sleep(3000);
						...
						List<WebElement> statuscol=getDriver().findElements(By.xpath("//*[@id='grid']/div[2]/table/tbody/tr/td[13]"));
						List<WebElement> Type=getDriver().findElements(By.xpath("//*[@id='grid']/div[2]/table/tbody/tr/td[4]"));
						//List<WebElement> Location=.findElements(By.xpath("//*[@id='grid']/div[2]/table/tbody/tr/td[3]"));
				 ...
				 public static void AdvancedSearchDocument(ExtentTest test) throws InterruptedException, IOException
				   {
					 WebDriverWait wait = new WebDriverWait(getDriver(), 60);
							 ...
							 performerPOM.AdvancedSearchReports().click();
						      Thread.sleep(4000);
						       performerPOM.clickDownloadDocumentAdvancedDearch().click();	
						       Thread.sleep(4000);
						       performerPOM.clickViewDocumentAdvancedDearch().click();	
						       ...
						       test.log(LogStatus.PASS, "Advanced Search(Case)=Document  Downloaded Successfully.");
								...
								performerPOM.selectTypeCase2().click();					//Selecting 'Case' option.
								 Thread.sleep(4000);
							       performerPOM.clickDownloadDocumentASNotice().click();	
							       Thread.sleep(4000);
							       performerPOM.clickViewDocumentASNotice().click();	
							       Thread.sleep(10000);
							       performerPOM.clickcloseViewDocument1().click();
...
//						performerPOM.selectDocument().click();	
						Thread.sleep(3000);
						performerPOM.shareDocumentIconNotice().click();
...
//						performerPOM.selectDocument().click();	
						...
						Thread.sleep(1000);
						performerPOM.shareDocumentIconTask().click();
						...
						//	.switchTo().alert().accept();
							...
							Thread.sleep(2000);
							OverduePOM.clickSearchPeople().sendKeys("Approver User");			//Writing user name to search for
						...
						public static void CriticalDocuments1(ExtentTest test) throws InterruptedException
						{
							...
							OverduePOM.uploadNewFile().sendKeys("D:\\Test Cases\\Approver Test Case.xlsx");	//uploading new file		
				 ...
				 public static void ReportCaseFilter(ExtentTest test) throws InterruptedException
					{
						...
						//	List<WebElement> loctioncol=.findElements(By.xpath("//*[@id='grid']/div[2]/table/tbody/tr/td[2]"));
				 ...
				 public static void ReportNoticeFilter(ExtentTest test) throws InterruptedException
					...
					public static void ReportTaskFilter(ExtentTest test) throws InterruptedException
					{
					       ...
					       //li.add(locationtext);
							...
							//List<WebElement> Prioritycol=.findElements(By.xpath("//*[@id='grid']/div[2]/table/tbody/tr/td[2]"));
							List<WebElement> Status=getDriver().findElements(By.xpath("//*[@id='grid']/div[2]/table/tbody/tr/td[6]"));
...
//						js.executeScript("window.scrollBy(500,0)");
					...
					//-------------------------------------------Notice--------------------------------------------------
						...
						Thread.sleep(4000);
						performerPOM.endDate().sendKeys("05/04/2024");
...
//						
						...
						try
						{
							...
							performerPOM.clickExternalUser().click();
							Thread.sleep(300);
							performerPOM.selectExternalUser().click();
							//Thread.sleep(500);
							//action.moveToElement(performerPOM.clickSearchExternalUser()).sendKeys(externalUser, Keys.ENTER).perform();
						}
						catch(Exception e)
...
//						
////						WebDriverWait wait3=new WebDriverWait(,30);
////						Thread.sleep(3000);
////						wait.until(ExpectedConditions.visibilityOf(performerPOM.readCaseMsg()));
//						
						Thread.sleep(500);
						...
						performerPOM.ChooseNoticeType().click();
						Thread.sleep(3000);
						performerPOM.ChooseNoticeFile4();
						Thread.sleep(3000);
...
//							
//						
//						WebDriverWait wait4=new WebDriverWait(,30);
//						Thread.sleep(3000);
...
//						action.moveToElement(performerPOM.clickTitle()).click().sendKeys(Keys.ARROW_DOWN, Keys.ARROW_DOWN, Keys.ENTER).perform();
						...
						Thread.sleep(3000);
						performerPOM.clickReminderText().sendKeys("Reminder  new 22march2024");
						
						Thread.sleep(3000);
						performerPOM.clickDescription().clear();
						
						Thread.sleep(3000);
						performerPOM.clickDescription().sendKeys("Reminder new 22march2024");
...
//						wait.until(ExpectedConditions.visibilityOf(performerPOM.clickType()));
						...
						Thread.sleep(3000);
						performerPOM.clickReminderText().sendKeys("Reminder  test 26march2023");
						
						Thread.sleep(3000);
						performerPOM.clickDescription().clear();
						
						Thread.sleep(3000);
						performerPOM.clickDescription().sendKeys("Reminder test 26march2023");
					  ...
					  public static void MailAuthorization(ExtentTest test) throws InterruptedException
					  {
						...
						public static void HearingCalender(ExtentTest test,String compliancesCount1, String type) throws InterruptedException, AWTException
						{
							     ...
							     catch (Exception e) 
							    {
						            ...
						            Thread.sleep(2000);    
								WebElement text=getDriver().findElement(By.xpath("//*[@id='collapseUpcomingHearing']/div/div[3]/div[1]/div/div[3]/div[10]/a"));
								if(text.isEnabled())
								{
									getDriver().findElement(By.xpath("//*[@id='collapseUpcomingHearing']/div/div[3]/div[1]/div/div[3]/div[10]/a")).click();
...
//            	selectOptionFromDropDown_bs(SeletcRisk, "High");
            	...
            	performerPOM.caseNoticeSummaryGraphClose().click();
            	  ...
            	  public static void ComplainantAgeingGraph(ExtentTest test, String type) throws InterruptedException, IOException
            		
            		{
            			...
            			performerPOM.clickDashboardNoticeFilter().click();
            			 ...
            			 Thread.sleep(5000);
            	       	...
            	       	int	open = Integer.parseInt(performerPOM.clickComplainantAgeing().getText());	//Reading Notice Open count.
            		    performerPOM.clickComplainantAgeing().click();						//Clicking on 'Open' notice
...
//            			selectOptionFromDropDown_bs(SeletcRisk, "High");
             ...
             public static void ComplainantAgeingGraph1to2years(ExtentTest test, String type) throws InterruptedException, IOException
          		
          		{
          			...
          			performerPOM.clickDashboardNoticeFilter().click();
          			 ...
          			 Thread.sleep(5000);
          	       	...
          	       	int	open = Integer.parseInt(performerPOM.clickComplianant().getText());	//Reading Notice Open count.
          		    performerPOM.clickComplianant().click();						//Clicking on 'Open' notice
       		...
       		
       		{
       			...
       			performerPOM.clickDashboardNoticeFilter().click();
       			 ...
       			 Thread.sleep(5000);
       	       	...
       	       	int	open = Integer.parseInt(performerPOM.clickInwardDefendent1to2().getText());	//Reading Notice Open count.
       		    performerPOM.clickInwardDefendent1to2().click();						//Clicking on 'Open' notice
...
//     			selectOptionFromDropDown_bs(SeletcRisk, "High");
         ...
         public static void InwardDefendentAgeingGraph2to3years(ExtentTest test, String type) throws InterruptedException, IOException
  		
  		{
  			...
  			performerPOM.clickDashboardNoticeFilter().click();
  			 ...
  			 Thread.sleep(5000);
  	       	...
  	       	int	open = Integer.parseInt(performerPOM.clickInwardDefendentCA2to3().getText());	//Reading Notice Open count.
  		    performerPOM.clickInwardDefendentCA2to3().click();						//Clicking on 'Open' notice
...
//  			selectOptionFromDropDown_bs(SeletcRisk, "High");
         ...
         public static void InwardDefendantAgeingGraphCase(ExtentTest test, String type) throws InterruptedException, IOException
   		
   		{
   			...
   			performerPOM.clickDashboardCaseFilter().click();
   			 ...
   			 Thread.sleep(5000);
   	       	...
   	       	int	open = Integer.parseInt(performerPOM.clickInwardDefendentCase().getText());	//Reading Notice Open count.
   		    performerPOM.clickInwardDefendentCase().click();						//Clicking on 'Open' notice
...
//  			selectOptionFromDropDown_bs(SeletcRisk, "High");
     	...
     	public static void CaseOneToTwoYearGraph(ExtentTest test, String type,int countType ) throws InterruptedException, IOException
		{
			...
			{
	         	Thread.sleep(2000);
		        performerPOM.CaseInwardDefendent1to2year().click();						//Clicking on 'Open' notice
			}
			else if(type.equalsIgnoreCase("Outward/Plaintiff Type"))
			{
				Thread.sleep(3000);
		        performerPOM.CaseOutwardPlaintiff1to2year().click();						//Clicking on 'Open' notice
			}
			else if(type.equalsIgnoreCase("Respondent Type"))
			{
				Thread.sleep(2000);
		        performerPOM.CaseRespondnent1to2year().click();						//Clicking on 'Open' notice
			}
			else if(type.equalsIgnoreCase("Complainant Type"))
			{
				Thread.sleep(2000);
		        performerPOM.CaseComplainant1to2year().click();						//Clicking on 'Open' notice
			}
     	  ...
     	  public static void Case2to3yeargraph(ExtentTest test, String type) throws InterruptedException, IOException
    		
    		{
    			...
    			performerPOM.clickDashboardCaseFilter().click();
    			 ...
    			 Thread.sleep(5000);
    	       	...
    	       	int	open = Integer.parseInt(performerPOM.CaseInwardDefendnent2to3year().getText());	//Reading Notice Open count.
    		    performerPOM.CaseInwardDefendnent2to3year().click();						//Clicking on 'Open' notice
...
// 				String internalUser = c1.getStringCellValue();
				...
				performerPOM.selectInternalUser5().click();
 				...
 				catch (Exception e) 
 				{
 					...
 					String msg1 = performerPOM.readTaskMsg().getText();
 					if(msg1.contains(msg1))
 					{
 						test.log(LogStatus.PASS, "Message displayed ="+msg1);
 					}
 						 ...
 						 jse.executeScript("arguments[0].click();",  performerPOM.clickSaveResponse());
 						  //performerPOM.clickSaveResponse().click();
 							...
 							try
							{
								...
								wait.until(ExpectedConditions.visibilityOf(performerPOM.readResponseMsg2()));
								Thread.sleep(500);
								String msg3 = performerPOM.readResponseMsg2().getText();		//Reading Message appeared after save button
 		 ...
 		 public static void CaseExistingHearingData(ExtentTest test) throws InterruptedException, IOException
			{
			      ...
			      //XSSFSheet sheet = ReadExcel();
				   ...
				   wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("showdetails"));
					...
					performerPOM.clickNewCaseHearing().click();
					Thread.sleep(3000);
                	performerPOM.clickCaseHearingDate().sendKeys("06-02-2025");	//Writing 'HearingDate'
				    Thread.sleep(3000);
				    performerPOM.clickSaveCaseHearingDate().click();
		...
		public static void CaseStatuswithEmptyFields(ExtentTest test) throws InterruptedException
		{
			  WebDriverWait wait=new WebDriverWait (getDriver(),20);
			   ...
			   Thread.sleep(3000);
				performerPOM.clickCaseStage().click();
				Thread.sleep(3000);
				performerPOM.selectCaseStage1().sendKeys("Select", Keys.ENTER);
				...
				public static void CaseNoticeTypeFilter(ExtentTest test,String type) throws InterruptedException
				{
					...
					JavascriptExecutor js = (JavascriptExecutor)getDriver() ;
			     	...
			     	if(type.equalsIgnoreCase("CaseNoticeTypeSummaryGraph"))
			     	{
			     		...
			     		Thread.sleep(2000);
			     		performerPOM.CaseNoticeTypeInwardDefendant().click();
			     	}
			     	...
			     	else if(type.equalsIgnoreCase("DepartmentSummaryGraph"))
			     	{
			     		js.executeScript("window.scrollBy(0,850)");
				     	Thread.sleep(2000);
				     	performerPOM.DepartmentSummaryGraph3().click();						//Clicking on 'Open' notice					//Clicking on 'Open' notice
			    	...
			    	else if(type.equalsIgnoreCase("LocationSummaryGraph"))
			     	{
				     	...
				     	Thread.sleep(2000);
				     	performerPOM.LocationSummaryGraphCase().click();						//Clicking on 'Open' notice					//Clicking on 'Open' notice
			     	...
			     	else if(type.equalsIgnoreCase("CategorySummaryGraph"))
			     	{
			     		js.executeScript("window.scrollBy(0,1700)");
				     	 Thread.sleep(2000);
				     	performerPOM.CategorySummaryGraph().click();						//Clicking on 'Open' notice				//Clicking on 'Open' notice					//Clicking on 'Open' notice
			     	...
			     	else if(type.equalsIgnoreCase("LessThanSummaryGraph"))
			     	{
			     		js.executeScript("window.scrollBy(0,3800)");
				     	 Thread.sleep(2000);
				     	performerPOM.clickInwardDefendentNoticeCA1to2().click();						//Clicking on 'Open' notice				//Clicking on 'Open' notice					//Clicking on 'Open' notice
			     	...
			     	else if(type.equalsIgnoreCase("1To2YearSummaryGraph"))
			     	{
			     		js.executeScript("window.scrollBy(0,3700)");
				     	 Thread.sleep(2000);
				     	performerPOM.clickOutwardPlaintiffNoticeCA2to3().click();						//Clicking on 'Open' notice				//Clicking on 'Open' notice					//Clicking on 'Open' notice
...
//				     performerPOM.clickRiskcol().click();
					...
					//List<WebElement> entitycol=.findElements(By.xpath("//*[@id='grid']/div[2]/table/tbody/tr/td[1]"));
...
//								{
				...
				public static void CaseNoticeStageFilter(ExtentTest test,String type) throws InterruptedException
				{
					...
					JavascriptExecutor js = (JavascriptExecutor)getDriver() ;
			     	//js.executeScript("window.scrollBy(0,800)");
			     		...
			     		js.executeScript("window.scrollBy(0,850)");
			     	  Thread.sleep(2000);
			          performerPOM.clickCaseNoticeStageHearingGraph1().click();
			       ...
			       performerPOM.clickCaseNotice().click();
				   Thread.sleep(500);
			       String caseNotice=performerPOM.selectCaseNotice1().getText();
			       Thread.sleep(500);
				   performerPOM.selectCaseNotice1().click();
			       Thread.sleep(500);
				   performerPOM.clickCaseNotice().click();
...
//								{
				...
				public static void RiskSummaryGraphFilter(ExtentTest test,String type) throws InterruptedException
				{
...
//							   }
	...
	//								{
				...
				public static void DepartmentSummaryGraphFilter(ExtentTest test,String type) throws InterruptedException
				{
...
//							   }
	...
	//								{
				...
				public static void LocationSummaryGraphFilter(ExtentTest test,String type) throws InterruptedException
				{
...
//							   }
	...
	//								{
				...
				public static void CategorySummaryGraphFilter(ExtentTest test,String type) throws InterruptedException
				{
					...
					WebDriverWait wait= new WebDriverWait(getDriver(), 20);
				      ...
				      Thread.sleep(500);
				       ...
				       performerPOM.clickRiskFilter().click();
				       Thread.sleep(1000);
				       String RiskText = performerPOM.selectRiskFilter3().getText();
				       Thread.sleep(1000);
				       performerPOM. selectRiskFilter3().click();
				       Thread.sleep(1000);
				       performerPOM.clickRiskFilter().click();
	...
	//				     performerPOM.clickRiskcol().click();
						...
						List<WebElement> Dept=getDriver().findElements(By.xpath("//*[@id='grid']/div[2]/table/tbody/tr/td[10]"));
						List<WebElement> Risk=getDriver().findElements(By.xpath("//*[@id='grid']/div[2]/table/tbody/tr/td[12]"));
						//List<WebElement> Category=.findElements(By.xpath("//*[@id='grid']/div[2]/table/tbody/tr/td[6]"));
						Thread.sleep(2000);
...
//							   }
	...
	//								{
				...
				public static void LessThanYearGraphFilter(ExtentTest test,String type) throws InterruptedException
				{
						...
						js.executeScript("window.scrollBy(0,3800)");
				     	 Thread.sleep(2000);
				     	performerPOM.clickAgeing1().click();								//Clicking on 'Open' notice
	...
	//								{
				...
				public static void Ageing1To2YearGraphFilter(ExtentTest test,String type) throws InterruptedException
				{
	...
	//								{
				...
				public static void Ageing2To3YearGraphFilter(ExtentTest test,String type) throws InterruptedException
				{
					WebDriverWait wait= new WebDriverWait(getDriver(), 20);
						JavascriptExecutor js = (JavascriptExecutor)getDriver() ;
	...
	//								{
				...
				public static void AgeingMoreThanYearGraphFilter(ExtentTest test,String type) throws InterruptedException
				{
		 		 ...
		 		 public static void ClosedNoticeDoc(ExtentTest test) throws InterruptedException, IOException
			 		{
						...
						performerPOM.selectTypeNotice().click();					//Selecting 'Case' option.
					       ...
					       performerPOM.clickFilter2().click();
					        ...
					        Thread.sleep(8000);
					       performerPOM.clickSearchFilterworkspace().sendKeys("Notice300623");
		 		 ...
		 		 public static void AdvancedSearchClosedCaseDoc(ExtentTest test) throws InterruptedException, IOException
			 		{
						...
						wait.until(ExpectedConditions.visibilityOf(performerPOM.GridLoad()));
					       ...
					       performerPOM.clickFilter2().click();
					        ...
					        Thread.sleep(8000);
					       performerPOM.clickSearchFilterworkspace().sendKeys("5745");
