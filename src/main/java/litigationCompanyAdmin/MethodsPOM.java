...
//	}
	...
	static void perform( ExtentTest test,  int open, int gridRecords, String type, String noticeCategory) throws InterruptedException, EncryptedDocumentException, IOException
	{
...
//				js.executeScript("window.scrollBy(0,-700)");
		...
		public static void clickAct() throws InterruptedException, EncryptedDocumentException, IOException
		{
		   ...
		   Thread.sleep(300);
		   progress();
	       Row row0 = sheet.getRow(67);						//Selected 0th index row (First row)
		   Cell c1 = row0.getCell(1);						//Selected cell (0 row,1 column)
...
//		performerPOM.clickOppLawyer().click();
		...
		public static void clickNoticeTitle() throws InterruptedException, EncryptedDocumentException, IOException
		{
	        ...
	        Sheet sheet = workbook.getSheetAt(4);
		  Thread.sleep(300);
		  Row row0 = sheet.getRow(71);						//Selected 0th index row (First row)
		 Cell c1 = row0.getCell(1);						//Selected cell (0 row,1 column)
		...
		public static void clickNoticeDescription() throws InterruptedException, EncryptedDocumentException, IOException
		{
	        ...
	        Sheet sheet = workbook.getSheetAt(4);
			Thread.sleep(300);
			Row row0 = sheet.getRow(72);						//Selected 0th index row (First row)
			Cell c1 = row0.getCell(1);						//Selected cell (0 row,1 column)
...
//		wait.until(ExpectedConditions.elementToBeClickable(performerPOM.clickLocation()));
	...
	//	performerPOM.clickNoticeDescription().sendKeys(Keys.PAGE_DOWN);
		...
		public static void clickJurisdiction() throws InterruptedException, EncryptedDocumentException, IOException
		{
	        ...
	        Sheet sheet = workbook.getSheetAt(4);
			 Thread.sleep(300);
			Row row0 = sheet.getRow(73);						//Selected 0th index row (First row)
			Cell c1 = row0.getCell(1);						//Selected cell (0 row,1 column)
		...
		public static void clickOwner() throws InterruptedException, EncryptedDocumentException, IOException
		{
	        ...
	        Sheet sheet = workbook.getSheetAt(4);
			Thread.sleep(300);
			Row row0 = sheet.getRow(77);					//Selected 0th index row (First row)
			Cell c1 = row0.getCell(1);						//Selected cell (0 row,1 column)
...
//		performerPOM.clickWinningProspect().click();
	...
	//	performerPOM.selectRisk().click();	          //Selecting 'Medium' Winning Prospect'
		...
		public static void clickNoticeBudget() throws InterruptedException, EncryptedDocumentException, IOException
		{
	        ...
	        Sheet sheet = workbook.getSheetAt(4);
			Thread.sleep(300);
			Row row0 = sheet.getRow(78);					//Selected 0th index row (First row)
			Cell c1 = row0.getCell(1);						//Selected cell (0 row,1 column)
		...
		public static void clickClaimedAmount() throws InterruptedException, EncryptedDocumentException, IOException
		{
	        ...
	        Sheet sheet = workbook.getSheetAt(4);
			Thread.sleep(300);
			Row row0 = sheet.getRow(79);					//Selected 0th index row (First row)
			Cell c1 = row0.getCell(1);						//Selected cell (0 row,1 column)
		...
		public static void clickState() throws InterruptedException, EncryptedDocumentException, IOException
		{
	        ...
	        Sheet sheet = workbook.getSheetAt(4);
			Thread.sleep(300);
			Row row0 = sheet.getRow(80);					//Selected 0th index row (First row)
			Cell c1 = row0.getCell(1);						//Selected cell (0 row,1 column)
		...
		public static void clickProbableAmount() throws InterruptedException, EncryptedDocumentException, IOException
		{
	        ...
	        Sheet sheet = workbook.getSheetAt(4);
			Thread.sleep(300);
			Row row0 = sheet.getRow(81);					//Selected 0th index row (First row)
			Cell c1 = row0.getCell(1);						//Selected cell (0 row,1 column)
		...
		public static void clickProtestMoney() throws InterruptedException, EncryptedDocumentException, IOException
		{
	        ...
	        Sheet sheet = workbook.getSheetAt(4);
			Thread.sleep(300);
			Row row0 = sheet.getRow(83);					//Selected 0th index row (First row)
			Cell c1 = row0.getCell(1);						//Selected cell (0 row,1 column)
...
//		performerPOM.clickMonetary().sendKeys("Automation123");
		...
		public static void clickLawFirm() throws InterruptedException, EncryptedDocumentException, IOException
		{
	        ...
	        Sheet sheet = workbook.getSheetAt(4);
			Thread.sleep(300);
			Row row0 = sheet.getRow(84);					//Selected 0th index row (First row)
			Cell c1 = row0.getCell(1);						//Selected cell (0 row,1 column)
		...
		public static void clickInternalUser() throws InterruptedException, EncryptedDocumentException, IOException
		{
	        ...
	        Sheet sheet = workbook.getSheetAt(4);
			Thread.sleep(300);
			Row row0 = sheet.getRow(85);						//Selected 0th index row (First row)
			Cell c1 = row0.getCell(1);						//Selected cell (0 row,1 column)
		...
		public static void clickLawyer() throws InterruptedException, EncryptedDocumentException, IOException
		{
	        ...
	        Sheet sheet = workbook.getSheetAt(4);
			Thread.sleep(300);
			Row row0 = sheet.getRow(86);						//Selected 0th index row (First row)
			Cell c1 = row0.getCell(1);						//Selected cell (0 row,1 column)
		...
		public static void NoticeDocument( ExtentTest test) throws InterruptedException
		{
	     ...
	     // Accepting alert		
	        ...
	        Thread.sleep(3000);
	        String msg1= performerPOM.clickNoticeDocumentsharereadmsgcfo1().getText();		//Reading Message appeared after save button
	...
	//	       //	elementsList = performerPOM.chooseAct();
	 ...
	 public  static void clickCaseInternalUser( ) throws InterruptedException, EncryptedDocumentException, IOException 
		...
		public static void clickLawyer1( ) throws InterruptedException, EncryptedDocumentException, IOException
		{
	        ...
	        Sheet sheet = workbook.getSheetAt(4);
			Thread.sleep(300);
			Row row0 = sheet.getRow(137);						//Selected 0th index row (First row)
			Cell c1 = row0.getCell(1);						//Selected cell (0 row,1 column)
			int lawyerNo = (int) c1.getNumericCellValue();
		...
		public static void clickLawFirm1( ) throws InterruptedException, EncryptedDocumentException, IOException
		{
	        ...
	        Sheet sheet = workbook.getSheetAt(4);
		 Thread.sleep(3000);
		 Row row1 = sheet.getRow(135);					//Selected 0th index row (First row)
		 Cell c2 = row1.getCell(1);						//Selected cell (0 row,1 column)
...
//				
		...
		public static void CaseOrder( ExtentTest test, String login) throws InterruptedException, EncryptedDocumentException, IOException
		{
			...
			// getDriver().switchTo().parentFrame();
			 ...
			 Thread.sleep(8000);
			 performerPOM. clickCaseOrderDate().sendKeys("07-10-2023");
			 Thread.sleep(8000);
...
//			 
		...
		public static void AdvocateBill(ExtentTest test) throws InterruptedException
		{
			...
			// performerPOM.clickLawFirm1().click();
			 Thread.sleep(2000);
//			 List<WebElement>selectLawFirm2 = getDriver().findElements(By.xpath("//li[@class='active-result']"));
...
//				}
	...
	public static void NoticeOpen( ExtentTest test, XSSFWorkbook workbook, String login) throws InterruptedException, IOException
	{
		...
		perform( test, open, gridRecords, "Notice - Open",compliancesCount);
	}
	
	public static void NoticeClosed( ExtentTest test,String login) throws InterruptedException, IOException
	{
		WebDriverWait wait = new WebDriverWait (getDriver(), 50);
	...
	public static void CaseOpen( ExtentTest test, String login) throws InterruptedException, IOException
	{
	...
	public static void CaseClosed( ExtentTest test,String login) throws InterruptedException, IOException
	{
		WebDriverWait wait = new WebDriverWait (getDriver(), 50);
	...
	public static void TaskClosed( ExtentTest test,  String login) throws InterruptedException, IOException
	{
		WebDriverWait wait = new WebDriverWait (getDriver(), 50);
	...
	public static void CloseNoticeCase( ExtentTest test,String type,String login) throws InterruptedException, IOException
	{
		...
		else if(type.equals("Case"))
		{
			...
			Thread.sleep(3000);
			performerPOM.selectCaseStage().click();
...
//		CFOcountPOM.clickNextPage1().sendKeys(Keys.PAGE_UP);
	...
	public static void MyReports( ExtentTest test,  String login) throws InterruptedException, IOException
	{
		WebDriverWait wait = new WebDriverWait (getDriver(), 60);
		progress();
...
//		}
		...
		Thread.sleep(8000);
		performerPOM.clickReminderText().sendKeys("Reminder as on dated 6jan2024");
	...
	public static void MyReminder( ExtentTest test) throws InterruptedException, IOException
	{
		WebDriverWait wait = new WebDriverWait (getDriver(), 180);
		progress();
...
//		  performerPOM.clickMastersMenu().click();
	  ...
	  public static void PageAuthorization( ExtentTest test) throws InterruptedException, IOException, AWTException
	  {
		  JavascriptExecutor js = (JavascriptExecutor)getDriver() ;
...
//		  String FY=c.getStringCellValue();
	  ...
	  public static void NoticeStage( ExtentTest test) throws InterruptedException, IOException, AWTException
	  {
		  sheet = workbook.getSheetAt(4);					//Retrieving second sheet of Workbook
	  ...
	  public static void UserReassignment( ExtentTest test) throws InterruptedException, IOException, AWTException
	  {
		  WebDriverWait Wait=new WebDriverWait(getDriver(),20);
		  Thread.sleep(3000);
		  performerPOM.clickMasters().click();
...
// 		    List<WebElement>SeletcRisk = getDriver().findElements(By.xpath("(//ul[@class='k-group k-treeview-lines'])[8]/li/div/span"));
...
//       	selectOptionFromDropDown_bs(SeletcRisk, "High");
	...
	public static void CaseHearing( ExtentTest test, String compliancesCount1,String type) throws InterruptedException, IOException
		...
		performerPOM.clickCaseHearing1().click();
				...
				Thread.sleep(5000);
				performerPOM.clickSearchFilter().sendKeys("45623");
			  ...
			  public static void AgeingGraphLessThanYear(ExtentTest test, String type,int counttype) throws InterruptedException, IOException
				
				{
					...
					JavascriptExecutor js = (JavascriptExecutor)getDriver();
						...
						{
				         	Thread.sleep(2000);
					        performerPOM.clickApplicantLessThanYearCaseCA().click();						//Clicking on 'Open' notice
						}
						else if(type.equalsIgnoreCase("Complainant"))
						{
				         	Thread.sleep(2000);
					        performerPOM.clickComplainantLessThanYearCaseCA().click();						//Clicking on 'Open' notice
						}
						else if(type.equalsIgnoreCase("Inward/Defendent"))
						{
				         	Thread.sleep(2000);
...

				{
					...
					WebDriverWait wait = new WebDriverWait (getDriver(),20);
					 JavascriptExecutor js = (JavascriptExecutor)getDriver();
						...
						{
				         	Thread.sleep(2000);
					        performerPOM.clickComplianant1to2yearCaseCA().click();						//Clicking on 'Open' notice
						}
						
						else if(type.equalsIgnoreCase("Inward/Defendent"))
						{
							Thread.sleep(3000);
					        performerPOM.clickInwardOutward1to2yearsCaseCA().click();						//Clicking on 'Open' notice
						}
...
//								{
	  ...
	  public static void RiskSummaryGraphFilter(ExtentTest test,String type) throws InterruptedException, IOException
      {
...
//								{
      ...
      public static void CaseNoticeTypeGraph1Filter( ExtentTest test, String type) throws InterruptedException, IOException
      {
    	  ...
    	  {
    		  Thread.sleep(2000);
    		  performerPOM.CaseNoticeTypeSummaryGraph().click();						//Clicking on 'Open' notice
    	  }
    	  else if(type.equalsIgnoreCase("Outward/Plaintiff Type"))
    	  {
    		  Thread.sleep(2000);
    		  performerPOM.CaseNoticeTypeInwardDefendent().click();						//Clicking on 'Open' notice
    	  }
    	  else if(type.equalsIgnoreCase("Respondent Type"))
    	  {
    		  Thread.sleep(2000);
    		  performerPOM.CaseNoticeTypeComplinant().click();						//Clicking on 'Open' notice
    	  }
    	  else if(type.equalsIgnoreCase("Petitioner Type"))
    	  {
    		  Thread.sleep(2000);
    		  performerPOM.CaseNoticeTypeRespondent().click();						//Clicking on 'Open' notice
    	  }
  	...
  	public static void RiskSummaryGraph1Filter(ExtentTest test, String type) throws InterruptedException, IOException
...
//								{
	...
	public static void AgeingGraph1to2yearsCaseFilter(ExtentTest test, String type) throws InterruptedException, IOException

	{
		...
		JavascriptExecutor js = (JavascriptExecutor)getDriver() ;
			...
			{
	         	Thread.sleep(2000);
		        performerPOM.clickInwardDefendentCA1to21().click();						//Clicking on 'Open' notice
			}
			
			else if(type.equalsIgnoreCase("Outward/Plaintiff"))
			{
				Thread.sleep(3000);
		        performerPOM.clickOutwardPlaintiffCaseCA().click();						//Clicking on 'Open' notice
			}
			else if(type.equalsIgnoreCase("Petitioner"))
			{
				Thread.sleep(3000);
		        performerPOM.clickPetitionerCAA().click();						//Clicking on 'Open' notice
			}
		
	     else if(type.equalsIgnoreCase("Respondent"))
			{
			   Thread.sleep(3000);
	           performerPOM.clickRespondentCA2().click();
			}
		Thread.sleep(2000);
		wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("showChartDetails"));
	...
	public static void AgeingGraph2to3yearsCaseFilter(ExtentTest test, String type) throws InterruptedException, IOException

	{
		...
		JavascriptExecutor js = (JavascriptExecutor)getDriver() ;
			...
			{
	         	Thread.sleep(2000);
		        performerPOM.clickInwardDefendentCA2to3Case().click();						//Clicking on 'Open' notice
			}
			
			else if(type.equalsIgnoreCase("Outward/Plaintiff"))
			{
				Thread.sleep(3000);
		        performerPOM.clickOutwardPlaintiffCaseCA2to3().click();						//Clicking on 'Open' notice
			}
	...
	public static void AgeingGraphMoreThan3yearsCaseFilter(ExtentTest test, String type) throws InterruptedException, IOException

	{
		...
		JavascriptExecutor js = (JavascriptExecutor)getDriver() ;
			...
			{
				Thread.sleep(3000);
		        performerPOM.clickOutwardPlaintiffCaseCAMoreThan3years().click();						//Clicking on 'Open' notice
			}
	...
	public static void NoticeDocumentSearchFields( ExtentTest test) throws InterruptedException
    	{
 		WebDriverWait wait = new WebDriverWait (getDriver(), 50);
			...
			Thread.sleep(8000);
			performerPOM.clickSearchDocument().sendKeys("Bita consulting ambegaon.docx");
...
//					clickCaseOppLawyer();
				...
				public static void CaseWithInvalidData( ExtentTest test, XSSFWorkbook workbook) throws InterruptedException, EncryptedDocumentException, IOException
				{
			...
			public static void CaseStatuswithEmptyFields( ExtentTest test) throws InterruptedException
			{
				  WebDriverWait wait=new WebDriverWait (getDriver(),20);
				   ...
				   Thread.sleep(8000);
					performerPOM.clickCaseStage().click();
					Thread.sleep(8000);
					performerPOM.selectCaseStage1().sendKeys("Select Stage", Keys.ENTER);
						   ...
						   else
						   {
							...
							/*  Thread.sleep(3000);
						       ...
						       performerPOM. SelectCaseNoticeFilter().click();
								...
								List<WebElement> CaseNoticeNocol=getDriver().findElements(By.xpath("//*[@id='grid']/div[2]/table/tbody/tr/td[2]"));
	 		 ...
	 		 public static void ClosedCaseDoc( ExtentTest test) throws InterruptedException, IOException
	 		{
	 			...
	 			//--------------------------------Case----------------------------------
			       ...
			       performerPOM.clickFilter2().click();
			        ...
			        Thread.sleep(8000);
			       performerPOM.clickSearchFilterworkspace().sendKeys("65234");
	 		 ...
	 		 public static void ClosedNoticeDoc( ExtentTest test) throws InterruptedException, IOException
		 		{
					...
					performerPOM.selectTypeNotice().click();					//Selecting 'Case' option.
				       ...
				       performerPOM.clickFilter2().click();
				        ...
				        Thread.sleep(8000);
				       performerPOM.clickSearchFilterworkspace().sendKeys("72345");
				       
				       Thread.sleep(3000);
				       performerPOM. selectCheckbox1().click();
