...
public class MgmtCount extends BasePage
{
...
//		driver = login.Login.UserLogin(uname,password,"cfo");		//Method of Login class to login user.
	...
	void SelectMultipleUsers() throws InterruptedException, IOException, AWTException
	{
		...
		MgmtMethod.SelectMultipleUsers( test);
	...
	//@Test(priority =5)
		void SelectMultipleUsersLeaveReport() throws InterruptedException, IOException, AWTException
		{
			...
			MgmtMethod.SelectMultipleUsersLeaveReport( test);
	...
	//@Test(priority =6)
		void UserFilterLeaveReport() throws InterruptedException, IOException, AWTException
		{
			...
			MgmtMethod.UserFilterLeaveReport( test);
	...
	@Test(priority =8)
			void ExportButtonLeaveReport() throws InterruptedException, IOException, AWTException
			{
				...
				MgmtMethod.ExportButtonLeaveReport( test);
