...
//		Thread.sleep(5000);
//		performerPOM.clickDashboardCaseNoticeFilter1().click();
...
//		performerPOM.clickcategory2().click();
	...
	public static void CustomerMgmt(ExtentTest test) throws InterruptedException
	{
	   ...
	   // Thread.sleep(3000);
	    //performerPOM.clickCustomerMgmtTerritorydropdown().get(0).click();
...
//		 	 	    performerPOM.clickCustomerMgmtok().click();
		 		 ...
		 		 /* Thread.sleep(2000);
				    performerPOM.clickPlanVisitdelete().click();
				    Thread.sleep(5000);
					   // Capturing alert message.    
				      ...
				      // Accepting alert		
				        driver.switchTo().alert().accept();	
				        Thread.sleep(2000);
					    performerPOM.clickPlanVisitOverdueVisit().click();*/
...
//	 	 	   
//	 	 	   if(!performerPOM.clickNoRecordFound().isDisplayed())
//	 	 	   {
