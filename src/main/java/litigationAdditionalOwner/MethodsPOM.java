	 ...
	 public  static void clickCaseInternalUser() throws InterruptedException, EncryptedDocumentException, IOException 
		...
		public static void clickLawFirm1() throws InterruptedException, EncryptedDocumentException, IOException
		{
			Thread.sleep(300);
			   FileInputStream fis = new FileInputStream(filePath);
		        ...
		        Sheet sheet = workbook.getSheetAt(2);
		 Thread.sleep(3000);
		 Row row1 = sheet.getRow(21);					//Selected 0th index row (First row)
		 Cell c2 = row1.getCell(1);						//Selected cell (0 row,1 column)
   	...
   	public static void Document(ExtentTest test) throws InterruptedException
		...
		public static void TaskActivity1( ExtentTest test, String login) throws InterruptedException, IOException
		{
		    ...
		    Thread.sleep(8000);
		    performerPOM.clickHearingDate().sendKeys("09-11-2025");
		    Thread.sleep(8000);
...
//				action.moveToElement(performerPOM.clickSearchExternalUser()).sendKeys(externalUser, Keys.ENTER).perform();
			...
			OverduePOM.clickSaveButton().click();				//Clicking on 'Save' button.
				...
				try
				{
					...
					Thread.sleep(8000);
					performerPOM.clickNoticeTaskcmtResponsecfo().sendKeys("Test 21Jan2024");
...
//				
				performerPOM.clickCaseHearingDate().sendKeys("12-10-2025");	//Writing 'HearingDate'
		...
		public static void CaseOrder( ExtentTest test,  String login) throws InterruptedException, EncryptedDocumentException, IOException
		{
			...
			// getDriver().switchTo().parentFrame();
			 ...
			 Thread.sleep(8000);
			 performerPOM. clickCaseOrderDate().sendKeys("12-11-2023");
			 Thread.sleep(8000);
...
//	    }
		...
		Thread.sleep(3000);
		int open = CFOMethod.CountExcel(test, "Notice - Open");
	...
	public static void NoticeClosed( ExtentTest test, XSSFWorkbook workbook, String login) throws InterruptedException, IOException
	{
		...
		CFOMethod.CountExcel( test, "Notice - Closed");
...
//	    }
		...
		int open = CFOMethod.CountExcel( test, "Case - Open");
	...
	public static void CaseClosed( ExtentTest test) throws InterruptedException, IOException
	{
		...
		CFOMethod.CountExcel( test, "Case - Closed");
...
//	    }
		...
		int open = CFOMethod.CountExcel( test, "Task - Open");
	...
	public static void TaskClosed( ExtentTest test, XSSFWorkbook workbook, String login) throws InterruptedException, IOException
	{
		...
		CFOMethod.CountExcel(test, "Task - Closed");
	...
	public static void CloseNoticeCase( ExtentTest test, String type,String login) throws InterruptedException, IOException
	{
		...
		else if(type.equals("Task"))
		{
			...
			else if(login.equalsIgnoreCase("performer regtrack"))	
			{
				...
				performerPOM.clickFilter().click();
				Thread.sleep(4000);
				performerPOM.clickSearchFilterworkspace1().sendKeys("performer regtrack");
				Thread.sleep(4000);
...
//		performerPOM.selectFromDate().click();
	...
	static void NewReminder( ExtentTest test, String type) throws InterruptedException
	{
		...
		Thread.sleep(8000);
		performerPOM.clickReminderText().sendKeys("Reminder as on date test 28mar2024");
		
		Thread.sleep(8000);
		performerPOM.clickDescription().sendKeys("Reminder as on date test 28mar2024");
		
		Thread.sleep(8000);
		performerPOM.clickRemark2().sendKeys("Reminder as on date test 28mar2024");
...
//		}
		...
		Thread.sleep(8000);
		performerPOM.clickReminderText().sendKeys("Reminder as on dated 11jan2024");
	...
	public static void CaseHearing( ExtentTest test, String compliancesCount1,String type) throws InterruptedException, IOException
		...
		performerPOM.clickCaseHearing1().click();
			...
			public static void HearingCalender(ExtentTest test,String compliancesCount1, String type) throws InterruptedException, AWTException
			{
				...
				while(true)
				{
			        String text=getDriver().findElement(By.xpath("//*[@id='collapseUpcomingHearing']/div/div[2]/div[1]/div/div[1]/h4")).getText();    //click month and year 
			           if(text.equals(month))
			           {
			            ...
			            {
			            	Thread.sleep(2000);
				        getDriver().findElement(By.xpath("//*[@id='collapseUpcomingHearing']/div/div[2]/div[1]/div/div[1]/a[2]/div")).click();           // click forward
			
				         }
				        Thread.sleep(3000);
				        getDriver().findElement(By.xpath("//*[@id='collapseUpcomingHearing']/div/div[2]/div[1]/div/div[3]/div/a[contains(text(),"+day+")]")).click();    //click day
...
//				robot.keyPress(KeyEvent.VK_SUBTRACT);
				...
				Thread.sleep(4000);
				WebElement text=getDriver().findElement(By.xpath("//*[@id='collapseUpcomingHearing']/div/div[3]/div[1]/div/div[3]/div[2]/a"));
				 
				Thread.sleep(4000);
				 if(text.isEnabled())
					{
						getDriver().findElement(By.xpath("//*[@id='collapseUpcomingHearing']/div/div[3]/div[1]/div/div[3]/div[2]/a")).click();
...
//					   }
	  ...
	  public static void LessThanYearGraphFilter(ExtentTest test, String type) throws InterruptedException, IOException
		
		{
			...
			JavascriptExecutor js = (JavascriptExecutor) getDriver();
				...
				{
		         	Thread.sleep(2000);
			        performerPOM.clickInwardDefendentCA().click();						//Clicking on 'Open' notice
				}
				else if(type.equalsIgnoreCase("Outward/Plaintiff"))
				{
					Thread.sleep(2000);
				...
				{
					Thread.sleep(3000);
			        performerPOM.clickPetitionerCA().click();						//Clicking on 'Open' notice
				}
				else if(type.equalsIgnoreCase("Respondent"))
				{
					Thread.sleep(3000);
			        performerPOM.clickRespondentCA().click();						//Clicking on 'Open' notice
				}
	  ...
	  public static void GraphFilter1to2years(ExtentTest test, String type) throws InterruptedException, IOException

	  {
	  	...
	  	JavascriptExecutor js = (JavascriptExecutor) getDriver();
	  		...
	  		{
	           	Thread.sleep(2000);
	  	        performerPOM.clickInwardDefendentCA1to2().click();						//Clicking on 'Open' notice
	  		}
	  ...
	  public static void GraphFilter2to3years(ExtentTest test, String type) throws InterruptedException, IOException
	  ...
	  public static void Morethan3yearsGraphFilter(ExtentTest test, String type) throws InterruptedException, IOException

	  {
	  	...
	  	JavascriptExecutor js = (JavascriptExecutor) getDriver();
	  		...
	  		{
	           	Thread.sleep(2000);
	  	        performerPOM.clickInwardDefendent1().click();						//Clicking on 'Open' notice
	  		}
...
//				}
	...
	public static void AgeingGraphLessThanYearFilter(ExtentTest test, String type) throws InterruptedException, IOException
	
	{
		...
		{
         	Thread.sleep(2000);
	        performerPOM.clickInwardDefendentCA1().click();						//Clicking on 'Open' notice
		}
		else if(type.equalsIgnoreCase("Outward/Plaintiff"))
		{
			Thread.sleep(2000);
	        performerPOM.clickOutwardPlaintiffAgeing1().click();						//Clicking on 'Open' notice
		}
		else if(type.equalsIgnoreCase("Petitioner"))
		{
			Thread.sleep(3000);
	        performerPOM.clickPetitionerCA1().click();						//Clicking on 'Open' notice
		}
		else if(type.equalsIgnoreCase("Respondent"))
		{
			Thread.sleep(3000);
	        performerPOM.clickRespondentCA1().click();						//Clicking on 'Open' notice
		}
...
//						performerPOM.selectDocument().click();	
						...
						//performerPOM.selectDocument1().click();
					     ...
					     //Select t=new Select(getDriver().findElement(By.xpath("/html/body/div[77]/div/div[2]/ul/li[2]")));
					  //  t.selectByIndex(1);
...
//						performerPOM.selectDocument().click();	
					...
					//	driver.switchTo().alert().accept();
						...
						/*	Thread.sleep(2000);
							...
							Thread.sleep(2000);
							performerPOM.ClickEditFolder().click();	
							
							Thread.sleep(8000);
							OverduePOM.writeFolderName().clear();			
							Thread.sleep(8000);
							OverduePOM.writeFolderName().sendKeys("Automation Test");			//Writing Folder name.
							
							Thread.sleep(8000);
							OverduePOM.clickCreate().click();	
					...
					public static void CriticalDocuments1( ExtentTest test) throws InterruptedException
					{
						...
						OverduePOM.uploadNewFile().sendKeys("D:\\Litigation-Project 10 April2024\\Litigation-Project 10 April2024\\TestData\\LitigationSheet.xlsx");	//uploading new file		
	 		 ...
	 		 public static void ClosedNoticeDoc( ExtentTest test) throws InterruptedException, IOException
		 		{
					...
					performerPOM.selectTypeNotice().click();					//Selecting 'Case' option.
				       ...
				       performerPOM.clickFilter2().click();
				        ...
				        Thread.sleep(8000);
				       performerPOM.clickSearchFilterworkspace().sendKeys("87234");
