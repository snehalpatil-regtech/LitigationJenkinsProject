...
public class performerPOM extends BasePage
{
	...
	{
		litigation = getDriver().findElement(By.xpath("(//a[normalize-space()='A Pvt Ltd'])[1]"));
...
//		 litigation =wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id='ddlDepartment_chosen']")));
	...
	public static WebElement selectExternalUser()
	{
		litigation = getDriver().findElement(By.xpath("//*[@id='ddlTaskUserExternal_chosen']/div/ul/li[2]"));
		return litigation;
	}
	public static WebElement selectExternalUser1()
	{
		litigation = getDriver().findElement(By.xpath("//*[@id='ddlTaskUserLawyerAndExternal_chosen']/div/ul/li[1]"));
		return litigation;
	}
	...
	public static WebElement clickClosedNoticeDoc()
	{
		
		WebElement closednoticedoc = getDriver().findElement(By.xpath("//input[@id='fuCloseStatusDoc']"));
		closednoticedoc.sendKeys("D:\\Test Cases\\Approver Test Case.xlsx");
		return litigation;
	}
	public static WebElement clickClosedNoticeViewDoc()
	{
		
		litigation = getDriver().findElement(By.xpath(" //img[@title='View Document']"));
		
		return litigation;
	}
	public static WebElement clickClosedNoticeViewDocClosedaPopup()
	{
		
		litigation = getDriver().findElement(By.cssSelector("div[id='DocumentReviewPopUp1'] button[type='button']"));
		
		return litigation;
	}
	public static WebElement clickDownloadDoc()
	{
		
		litigation = getDriver().findElement(By.xpath("//img[@title='DownLoad Documents']"));
	...
	{
		litigation = getDriver().findElement(By.xpath("//*[@id=\"ddlNoticeStage_chosen\"]"));
		return litigation;
	}
	public static WebElement selectCaseStage()
	{
		litigation = getDriver().findElement(By.xpath("//*[@id='ddlCaseStage_chosen']/div/ul/li[3]"));
		return litigation;
	}
	public static WebElement selectCaseStage1()
	{
		litigation = getDriver().findElement(By.xpath("//*[@id='ddlCaseStage_chosen']/div/div/input"));
		return litigation;
	}
	public static WebElement selectNoticetage1()
	{
		litigation = getDriver().findElement(By.xpath("//*[@id=\"ddlNoticeStage_chosen\"]/div/ul/li[2]"));
		return litigation;
	}
	...
	{
		litigation = getDriver().findElement(By.xpath("(//li[@role='option'][normalize-space()='Task'])[1]"));
		return litigation;
	}
	...
	public static WebElement readDocMsgInvalidMsg()
	{
	 ...
	 public static WebElement clickNewDocument()
	    ...
	    public static void selectDocumentType()
	    {
		    ...
		    {
		    	 WebElement DocumentType = getDriver().findElement(By.xpath ("//*[@id='ddlDocType_chosen']/div/ul/li[2]"));
	    ...
	    public static void selectUploadDocument() 
		 ...
		 public static WebElement readTaskMsg()
			{
				litigation = getDriver().findElement(By.xpath("//*[@id='ValidationSummary5']"));
				return litigation;
			}
		 ...
		 public static WebElement readTaskMsgcfo()
			{
				litigation = getDriver().findElement(By.xpath("//*[@id='ValidationSummary5']/ul/li"));
				return litigation;
			}
	    ...
	    {      
		 ...
		 public static WebElement selectInternalUser5() 
	      {
			  WebDriverWait wait = new WebDriverWait(getDriver(), 300);
...
//		        TaskPanel.click();
		 ...
		 public static WebElement selectInternalUser4()
		    {      
		...
		public static WebElement clickApprover1()
		 ...
		 public static WebElement clickCaseInvoiceNo1()
		 {
		  ...
		  public static WebElement clickDownloadDocumentNotice()
			{
		  ...
		  public static WebElement clickDownloadDocumentTask()
			{
		  ...
		  public static WebElement clickDownloadDocument1()
		    ...
		    public static WebElement clickViewDocumentNotice()
		 			{
		    ...
		    public static WebElement clickViewDocumentTask()
 			{
		    ...
		    public static WebElement clickDownloadDocumentASNotice()
			{
		    ...
		    public static WebElement clickViewDocumentASNotice()
			{
		    ...
		    public static WebElement clickDownloadDocumentAdvancedDearch()
			{
		    ...
		    public static WebElement clickViewDocumentAdvancedDearch()
			{
		  ...
		  public static WebElement ChooseCaseFile4() throws InterruptedException
		  {
	  ...
	  public static WebElement ChooseNoticeFile4() throws InterruptedException
	  {
	  ...
	  public static WebElement CaseNoticeTypeSummaryGraph() throws InterruptedException
	  {
	  ...
	  public static WebElement LocationSummaryGraphNotice() throws InterruptedException
	  {
		 
		  litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-0 '])[6]"));
...
//				WebDriverWait wait= new WebDriverWait(getDriver(),30);
			...
			public static WebElement readPageAuthoMsg()
			{
				...
				litigation =getDriver().findElement(By.xpath("//*[@id='ContentPlaceHolder1_ValidationSummary2']/ul/li"));
				return litigation;
			}
			...
			{
				litigation=getDriver().findElement(By.xpath("//span[normalize-space()='Notice']"));
				return litigation;
			}
			public static WebElement selectCaseNotice1()
			{
			...
			{
				litigation=getDriver().findElement(By.xpath("(//span[@class='k-in'][normalize-space()='HR'])[1]"));
				return litigation;
			}
			...
			public static WebElement selectRiskFilter3()
			{
				litigation=getDriver().findElement(By.xpath("//span[@class='k-in'][normalize-space()='High']"));
				return litigation;
			}
			...
			{
				litigation=getDriver().findElement(By.xpath("(//span[@class='k-in'])[145]"));
				return litigation;
			}
			...
			{
				litigation=getDriver().findElement(By.xpath("//span[normalize-space()='CNType']"));
				return litigation;
			}
			public static WebElement selectCategoryFilterGraph()
			{
				litigation=getDriver().findElement(By.xpath("(//span[@class='k-in'][normalize-space()='Tax Laws'])[1]"));
				return litigation;
			}
			...
			public static WebElement clickTrignle3()
			{
				litigation=getDriver().findElement(By.xpath("(//span[@class='k-icon k-i-more-vertical'])[4]"));
				return litigation;
			}
			public static WebElement clickTrignle4()
			{
				litigation=getDriver().findElement(By.xpath("(//span[@class='k-icon k-i-more-vertical'])[17]"));
				return litigation;
			}
			...
			{
				litigation=getDriver().findElement(By.xpath("//li[@class='k-item k-filter-item k-state-default k-last']"));
				return litigation;
			}
			...
			public static WebElement clickFilter3()
			{
				litigation=getDriver().findElement(By.xpath("//button[@type='submit']"));
				return litigation;
			}
			public static WebElement selectCheckbox()
			{
				litigation=getDriver().findElement(By.xpath("//label[normalize-space()='5435']"));
				return litigation;
			}
			public static WebElement selectCheckboxcfo()
			{
				litigation=getDriver().findElement(By.xpath("//label[normalize-space()='Notice300623']"));
				return litigation;
			}
			public static WebElement selectCheckbox1()
			{
				litigation=getDriver().findElement(By.xpath("//label[normalize-space()='87234']"));
				return litigation;
			}
			public static WebElement selectCheckboxcfo1()
			{
				litigation=getDriver().findElement(By.xpath("//label[normalize-space()='1042024']"));
				return litigation;
			}
			public static WebElement clickDoc()
			{
				litigation=getDriver().findElement(By.xpath("//*[@id='grid']/div[2]/table/tbody/tr[1]/td[15]/span/span/span[1]"));
				return litigation;
			}
			public static WebElement clickDoc1()
			{
				litigation=getDriver().findElement(By.xpath("//*[@id='grid1']/div[3]/table/tbody/tr[1]/td[13]/span/span/span[1]"));
				return litigation;
			}
			public static WebElement selectDoc()
			{
				litigation=getDriver().findElement(By.xpath("/html/body/div[236]/div/div[2]/ul/li[6]"));
				return litigation;
			}
			public static WebElement selectDoc1()
			{
				litigation=getDriver().findElement(By.xpath("//div[@class='k-animation-container']//li[@role='option'][normalize-space()='Closed Notice Documents']"));
				return litigation;
			}
			public static WebElement clickScroll()
			{
				litigation=getDriver().findElement(By.xpath("(//div[@class='k-list-scroller'])[41]"));
				return litigation;
			}
			...
			{
				litigation=getDriver().findElement(By.xpath("//input[@value='performer regtrack']"));
				return litigation;
			}
			...
			public static WebElement HearingCalenderNum()
			{
				...
				litigation=getDriver().findElement(By.xpath("//*[@id='collapseUpcomingHearing']/div/div[3]/div[1]/div/div[3]/div[10]/span"));
				return litigation;
			}
			...
			{
				//WebDriverWait wait=new WebDriverWait(getDriver(),30);
				litigation=getDriver().findElement(By.xpath("//button[@onclick='exportReportMain(event)']"));
				return litigation;
			}
			...
			{
				litigation=getDriver().findElement(By.xpath("(//span[@class='k-in'][normalize-space()='HR'])"));
				return litigation;
			}
			...
			{
				litigation=getDriver().findElement(By.xpath("//*[@id='grid1']/div[2]/table/tbody/tr[1]/td[19]/a[1]"));
				return litigation;
			}
			public static WebElement clickdeleteButton()
			{
			...
			{
				litigation=getDriver().findElement(By.xpath("(//span[@class='k-in'])[3]"));
				return litigation;
			}
			...
			{
				litigation=getDriver().findElement(By.xpath("(//span[normalize-space()='IT'])[1]"));
				return litigation;
			}
			...
			{
				litigation=getDriver().findElement(By.xpath("//span[@class='k-in k-state-selected'][normalize-space()='Inward/Defendant']"));
				return litigation;
			}
			public static WebElement selectReportTypeFilterCase()
			{
				litigation=getDriver().findElement(By.xpath("(//span[@role='presentation'])[56]"));
				return litigation;
			}
			...
			{
				litigation=getDriver().findElement(By.xpath("(//li[@role='option'][normalize-space()='2024-2025'])[1]"));
				return litigation;
			}
			...
			public static WebElement selectStageFilter2()
			{
			 ...
			 public static WebElement RiskSummaryHigh1() throws InterruptedException
			  {
			 ...
			 public static WebElement RiskSummaryMedium1() throws InterruptedException
			  {
				  
				  litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-1 '])[3]"));
				  return litigation;
			  }
			 ...
			 public static WebElement RiskSummaryLowCA() throws InterruptedException
			  {
				  ...
				  litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-2 '])[3]"));
				  return litigation;
			  }
			 ...
			 public static WebElement RiskSummaryNotApplicableCA() throws InterruptedException
			  {
				  ...
				  litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-3 '])[3]"));
				  return litigation;
			  }
			 ...
			 public static WebElement clickApplicantLessThanYearCase()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-0 '])[40]"));
					return litigation;
				}
			 public static WebElement clickApplicantLessThanYearCaseCA()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-0 '])[40]"));
					return litigation;
				}
			 public static WebElement clickComplainantLessThanYearCase()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-1 '])[40]"));
					return litigation;
				}
			 public static WebElement clickComplainantLessThanYearCaseCA()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-1 '])[40]"));
					return litigation;
				}
			 ...
			 public static WebElement clickAppellantLessThanYearCase()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-3 '])[9]"));
					return litigation;
				}
			 public static WebElement clickOutwardPlaintiffLessthanyearCase()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-4 '])[7]"));
					return litigation;
				}
			 ...
			 public static WebElement clickRespondentLessThanYearCase()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-6 '])[6]"));
					return litigation;
				}
			 public static WebElement clickComplianant1to2yearCase()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-0 '])[41]"));
					return litigation;
				}
			 public static WebElement clickComplianant1to2yearCaseCA()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-0 '])[41]"));
					return litigation;
				}
			 public static WebElement clickInwardOutward1to2yearsCase()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-1 '])[41]"));
					return litigation;
				}
			 public static WebElement clickInwardOutward1to2yearsCaseCA()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-1 '])[41]"));
					return litigation;
				}
			 ...
			 public static WebElement clickApplicant2to3yearCase()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-0 '])[42]"));
					return litigation;
				}
			 ...
			 public static WebElement clickRespondent2To3YearCase()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-5 '])[8]"));
					return litigation;
				}
			 ...
			 public static WebElement CaseNoticeTypeInwardDefendant() throws InterruptedException
			  {
			 ...
			 public static WebElement CaseNoticeTypeOutwardPlaintiff2() throws InterruptedException
			  {
				  
				  litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-5 '])"));
				  return litigation;
			  }
			 public static WebElement CaseNoticeTypeOutwardPlaintiff1() throws InterruptedException
			  {
				  
				  litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-0 '])"));
				  return litigation;
			  }
			 public static WebElement CaseNoticeTypeInwardDefendent() throws InterruptedException
			  {
				  
				  litigation=getDriver().findElement(By.xpath("//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-1 ']"));
				  return litigation;
			  }
			 public static WebElement CaseNoticeTypeuoutwardplaintiff() throws InterruptedException
			  {
				  
				  litigation=getDriver().findElement(By.xpath("//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-3 ']"));
				  return litigation;
			  }
			 public static WebElement CaseNoticeTypeComplinant() throws InterruptedException
			  {
				  
				  litigation=getDriver().findElement(By.xpath("//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-3 ']"));
				  return litigation;
			  }
			 public static WebElement CaseNoticeTypePetioner() throws InterruptedException
			  {
				  
				  litigation=getDriver().findElement(By.xpath("//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-5 ']"));
				  return litigation;
			  }
			 public static WebElement CaseNoticeTypeRespondent() throws InterruptedException
			  {
			 ...
			 public static WebElement CaseNoticeTypeApplicant1() throws InterruptedException
			  {
			 ...
			 public static WebElement CaseNoticeTypeApplicant2() throws InterruptedException
			  {
			 ...
			 public static WebElement ExpensesCounselWiseCaseGraph() throws InterruptedException
			  {
				  ...
				  litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-1 '])[35]"));
				  return litigation;
			  }
			 public static WebElement ExpensesCounselWiseCaseGraphCA() throws InterruptedException
			  {
				  
				  litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-0 '])[38]"));
				  return litigation;
			  }
			 public static WebElement UtilizedBudgetGraph() throws InterruptedException
			  {
				  
				  litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-0 '])[48]"));
				  return litigation;
			  }
			 public static WebElement UtilizedBudgetGraphCA() throws InterruptedException
			  {
				  
				  litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-0 '])[39]"));
				  return litigation;
			  }
			 
			 public static WebElement ExpensesCaseNo() throws InterruptedException
			  {
				  
				  litigation=getDriver().findElement(By.xpath("(//*[local-name()='svg']//*[name()='g' and @class='highcharts-axis-labels highcharts-xaxis-labels '])[6]//*[name()='text']//*[name()='tspan']"));
				  return litigation;
			  }
			 public static WebElement ExpensesCategoryNo() throws InterruptedException
			  {
				  
				  litigation=getDriver().findElement(By.xpath("(//*[local-name()='svg']//*[name()='g' and @class='highcharts-axis-labels highcharts-xaxis-labels '])[7]//*[name()='text']//*[name()='tspan']"));
				  return litigation;
			  }
			 public static WebElement ExpensesCansilNo() throws InterruptedException
			  {
				  
				  litigation=getDriver().findElement(By.xpath("(//*[local-name()='svg']//*[name()='g' and @class='highcharts-axis-labels highcharts-xaxis-labels '])[8]//*[name()='text']//*[name()='tspan']"));
				  return litigation;
			  }
			 ...
			 public static WebElement CaseInwardDefendent1to2year() throws InterruptedException
			  {
				  ...
				  litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-1 '])[50]"));
				  return litigation;
			  }
			 public static WebElement CaseOutwardPlaintiff1to2year() throws InterruptedException
			  {
				  
				  litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-2 '])[13]"));
				  return litigation;
			  }
			 public static WebElement CaseRespondnent1to2year() throws InterruptedException
			  {
				  
				  litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-4 '])[12]"));
				  return litigation;
			  }
			 public static WebElement CaseComplainant1to2year() throws InterruptedException
			  {
				  
				  litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-0 '])[50]"));
				  return litigation;
			  }
			 public static WebElement CaseInwardDefendnent2to3year() throws InterruptedException
			  {
				  
				  litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-0 '])[51]"));
				  return litigation;
			  }
			 ...
			 public static WebElement selectLocationCfo() throws InterruptedException
			  {
				  ...
				  litigation=getDriver().findElement(By.xpath("//*[@id='tvBranchest4']"));
				  return litigation;
			  }
			 public static WebElement SelectLocation1() throws InterruptedException
			  {
				  
				  litigation=getDriver().findElement(By.xpath("//*[@id='tvBranchest1']"));
				  return litigation;
			  }
			 ...
			 public static WebElement clickNoticeDocumentsharereadmsgcfo1() throws InterruptedException
			  {
			 ...
			 public static WebElement clickNoticeTaskclosed() throws InterruptedException
			  {
				  
				  litigation=getDriver().findElement(By.xpath("//*[@id='grdTaskActivity_lblTaskStatus_0']"));
				  return litigation;
			  }
			 ...
			 public static WebElement clickMinimize1()
				{
					litigation=getDriver().findElement(By.xpath("//*[@id='DivTaskCollapsOne']/div/div/div[1]/div/div/a/i"));
					return litigation;
				}
			 ...
			 public static WebElement clickStatus1()
				{
					litigation=getDriver().findElement(By.xpath("//span[normalize-space()='Select Status']"));
					return litigation;
				}
			 public static WebElement clickStatusdropdown()
				{
			 ...
			 public static WebElement clickPetitionerNoticeCA1To2Years()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-4 '])[5]"));
					return litigation;
				}
			 ...
			 public static WebElement clickPlaintiffNoticeCA2to3()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-5 '])[5]"));
					return litigation;
				}
			 
			 public static WebElement clickInwardDefendentMorethan3years()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-1 '])[11]"));
					return litigation;
				}
			 public static WebElement clickInwardDefendentMorethan3years1()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-1 '])[29]"));
					return litigation;
				}
			 ...
			 public static WebElement clickInwardDefendentCA()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-1 '])[12]"));
					return litigation;
				}
			 public static WebElement clickInwardDefendentCA1()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-1 '])[57]"));
					return litigation;
				}
			 public static WebElement clickInwardDefendentCA1to2()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-1 '])[13]"));
					return litigation;
				}
			 
			 public static WebElement clickInwardDefendentCA1to21()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-0 '])[59]"));
					return litigation;
				}
			 public static WebElement clickInwardDefendentCA2to3Case()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-0 '])[60]"));
					return litigation;
				}
			 public static WebElement clickInwardDefendentCAMoreThan3yearsCase()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-0 '])[43]"));
					return litigation;
				}
			 public static WebElement clickAppleantCaseCAMoreThan3years()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-1 '])[43]"));
					return litigation;
				}
			 public static WebElement clickPetitionerCaseCAMoreThan3years()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-3 '])[12]"));
					return litigation;
				}
			 ...
			 public static WebElement clickComplainantAgeing()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-2 '])[11]"));
					return litigation;
				}
			 ...
			 public static WebElement clickOutwardPlaintiffAgeing1()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-3 '])[13]"));
					return litigation;
				}
			 ...
			 public static WebElement clickInwardDefendent()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-1 '])[92]"));
					return litigation;
				}
			 public static WebElement clickInwardDefendent1to2()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-2 '])[11]"));
					return litigation;
				}
			 ...
			 public static WebElement clickRespondent()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-4 '])[10]"));
					return litigation;
				}
			 public static WebElement clickInwardDefendent1()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-0 '])[15]"));
					return litigation;
				}
			 public static WebElement clickInwardDefendentCA2to3()
				{
			 ...
			 public static WebElement clickInwardDefendentCase()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-2 '])[12]"));
					return litigation;
				}
			 public static WebElement clickOutwardPlaintiffCase()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-4 '])[11]"));
					return litigation;
				}
			 public static WebElement clickOutwardPlaintiffCaseCA()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-2 '])[15]"));
					return litigation;
				}
			 public static WebElement clickOutwardPlaintiffCaseCA2to3()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-1 '])[59]"));
					return litigation;
				}
			 public static WebElement clickOutwardPlaintiffCaseCAMoreThan3years()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-2 '])[16]"));
					return litigation;
				}
			 public static WebElement clickPetitionerCase()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-5 '])[11]"));
					return litigation;
				}
			 public static WebElement clickPetitionerCase1()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-5 '])"));
					return litigation;
				}
			 public static WebElement clickPetitioner1to2year()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-3 '])[12]"));
					return litigation;
				}
			 public static WebElement clickPetitionerCA()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-3 '])[11]"));
					return litigation;
				}
			 public static WebElement clickPetitionerCA1To2Years()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-2 '])[12]"));
					return litigation;
				}
			 public static WebElement clickOutwordPliantiff()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-3 '])"));
					return litigation;
				}
			 public static WebElement clickOutwordPliantiff1to2year()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-2 '])[12]"));
					return litigation;
				}
			 public static WebElement clickPetitionerCA1()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-4 '])[11]"));
					return litigation;
				}
			 public static WebElement clickPetitionerCAA()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-3 '])[14]"));
					return litigation;
				}
			 public static WebElement clickRespondentCA()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-4 '])[7]"));
					return litigation;
				}
			 public static WebElement clickRespondentCA1To2Years()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-4 '])[8]"));
					return litigation;
				}
			 public static WebElement clickRespondent1()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-4 '])"));
					return litigation;
				}
			 public static WebElement clickRespondent1to2year()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-4 '])[8]"));
					return litigation;
				}
			 public static WebElement clickRespondentCA1()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-4 '])[12]"));
					return litigation;
				}
			 public static WebElement clickRespondentCA2()
				{
					litigation=getDriver().findElement(By.xpath("(//*[@class='highcharts-label highcharts-data-label highcharts-data-label-color-4 '])[13]"));
					return litigation;
				}
			 ...
			 public static WebElement shareDocumentIcon1()
				{
					litigation=getDriver().findElement(By.xpath("//*[@id='grid1']/div[3]/table/tbody/tr[1]/td[12]/a[3]"));
					return litigation;
				}
			 public static WebElement shareDocumentIconNotice()
				{
					litigation=getDriver().findElement(By.xpath("//*[@id='grid1']/div[3]/table/tbody/tr[1]/td[13]/a[3]"));
					return litigation;
				}
			 public static WebElement shareDocumentIconTask()
				{
					litigation=getDriver().findElement(By.xpath("//*[@id='grid']/div[2]/table/tbody/tr[1]/td[14]/a[3]"));
					return litigation;
				}
			 ...
			 public static WebElement StageName()
				{
					litigation=getDriver().findElement(By.xpath("(//*[name()='tspan'][contains(text(),'Notice Stage')])[1]"));
					return litigation;
				}
			 public static WebElement StageNameCA()
				{
					litigation=getDriver().findElement(By.xpath("(//*[name()='tspan'][contains(text(),'Closed Notice')])[1]"));
					return litigation;
				}
			 public static WebElement CaseStageName()
				{
					litigation=getDriver().findElement(By.xpath("(//*[name()='tspan'][contains(text(),'Hearing')])[1]"));
					return litigation;
				}
			 public static WebElement CaseStageName1()
				{
					litigation=getDriver().findElement(By.cssSelector("#highcharts-0 > svg > g.highcharts-axis-labels.highcharts-xaxis-labels > text:nth-child(1) > tspan"));
					return litigation;
				}
			 public static WebElement DepartName()
				{
					litigation=getDriver().findElement(By.xpath("(//*[name()='text'][normalize-space()='HR'])[1]"));
					return litigation;
				}
			 ...
			 public static WebElement LocationName1()
				{
					litigation=getDriver().findElement(By.cssSelector("#highcharts-8 > svg > g.highcharts-axis-labels.highcharts-xaxis-labels > text:nth-child(2) > tspan"));
					return litigation;
				}
			 public static WebElement CategoryName()
				{
					litigation=getDriver().findElement(By.xpath("(//*[name()='tspan'][normalize-space()='CNType'])[1]"));
					return litigation;
				}
			 public static WebElement CategoryName1()
				{
					litigation=getDriver().findElement(By.cssSelector("#highcharts-6 > svg > g.highcharts-axis-labels.highcharts-xaxis-labels > text:nth-child(2) > tspan"));
					return litigation;
				}
