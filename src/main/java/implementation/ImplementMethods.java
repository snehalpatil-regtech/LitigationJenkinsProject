...
public class ImplementMethods extends BasePage
{
	...
	public static void UserLogReport( ExtentTest test) throws InterruptedException, IOException
	{
    	...
    	Thread.sleep(5000);
    	ImplementPOM.clickReport().click();
       	
    	
       	if(ImplementPOM.clickUserLogReport().isDisplayed())
		{
			Thread.sleep(7000);
			ImplementPOM.clickUserLogReport().click();
	...
	public static void SelectMultipleUsers( ExtentTest test) throws InterruptedException, IOException
	{
		...
		Thread.sleep(7000);
		ImplementPOM.clickUser().click();
		
		Thread.sleep(7000);
		ImplementPOM.selectUser().click();
		
		Thread.sleep(7000);
		ImplementPOM.selectUser1().click();
		
		
		Thread.sleep(4000);
	  	if(ImplementPOM.clickApplyBtn().isEnabled())
			{
				Thread.sleep(4000);
				ImplementPOM.clickApplyBtn().click();
	...
	public static void UserFilter( ExtentTest test) throws InterruptedException, IOException
	{
			...
			ImplementPOM.clickUser().click();	  
		   	Thread.sleep(500);
	       	String user=ImplementPOM.selectUser().getText();
	       	Thread.sleep(500);
	       	ImplementPOM.selectUser().click();
	       	Thread.sleep(500);
	       	ImplementPOM.clickApplyBtn().click();
	...
	public static void ExportButton( ExtentTest test) throws InterruptedException, IOException
	{
	    ...
	    try
		{
	    	ImplementPOM.clickExport().sendKeys(Keys.PAGE_DOWN);
		}
		catch(Exception e)
		{
		...
		Thread.sleep(250);
		ImplementPOM.clickExport().click();					//Clicking on 'Excel Report' image.
